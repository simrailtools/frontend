...
import type { FindUsersBySteamIdsData, FindUsersBySteamIdsResponse, FindUsersBySteamIdsError, FindRailcarsByIdsData, FindRailcarsByIdsResponse, FindRailcarsByIdsError, FindPointsByIdData, FindPointsByIdResponse, FindPointsByIdError, FindJourneysByIdsData, FindJourneysByIdsResponse, FindJourneysByIdsError, FindVehicleCompositionByJourneyIdData, FindVehicleCompositionByJourneyIdResponse, FindVehicleCompositionByJourneyIdError, FindServerByIdData, FindServerByIdResponse, FindServerByIdError, FindServerByCodeData, FindServerByCodeResponse, FindServerByCodeError, ListServersData, ListServersResponse, ListServersError, FindRailcarByApiNameData, FindRailcarByApiNameResponse, FindRailcarByApiNameError, FindRailcarByIdData, FindRailcarByIdResponse, FindRailcarByIdError, FindPointByPositionData, FindPointByPositionResponse, FindPointByPositionError, FindPointBySimRailPointIdData, FindPointBySimRailPointIdResponse, FindPointBySimRailPointIdError, FindPointByNameData, FindPointByNameResponse, FindPointByNameError, FindPointByIdData, FindPointByIdResponse, FindPointByIdError, ListPointsData, ListPointsResponse, ListPointsError, FindMapPolylineByJourneyData, FindMapPolylineByJourneyResponse, FindMapPolylineByJourneyError, FindJourneysByRailcarData, FindJourneysByRailcarResponse, FindJourneysByRailcarError, FindJourneysByTailData, FindJourneysByTailResponse, FindJourneysByTailError, FindJourneysByPlayableDepartureData, FindJourneysByPlayableDepartureResponse, FindJourneysByPlayableDepartureError, FindJourneyByIdData, FindJourneyByIdResponse, FindJourneyByIdError, FindJourneysByEventData, FindJourneysByEventResponse, FindJourneysByEventError, ListActiveJourneysData, ListActiveJourneysResponse, ListActiveJourneysError, FindDispatchPostsData, FindDispatchPostsResponse, FindDispatchPostsError, FindDispatchPostByIdData, FindDispatchPostByIdResponse, FindDispatchPostByIdError, ListBoardDeparturesData, ListBoardDeparturesResponse, ListBoardDeparturesError, ListBoardArrivalsData, ListBoardArrivalsResponse, ListBoardArrivalsError } from './types.gen';
...
export const findUsersBySteamIds = <ThrowOnError extends boolean = false>(options: Options<FindUsersBySteamIdsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<FindUsersBySteamIdsResponse, FindUsersBySteamIdsError, ThrowOnError>({
...
export const findRailcarsByIds = <ThrowOnError extends boolean = false>(options: Options<FindRailcarsByIdsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<FindRailcarsByIdsResponse, FindRailcarsByIdsError, ThrowOnError>({
...
export const findPointsById = <ThrowOnError extends boolean = false>(options: Options<FindPointsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<FindPointsByIdResponse, FindPointsByIdError, ThrowOnError>({
...
export const findJourneysByIds = <ThrowOnError extends boolean = false>(options: Options<FindJourneysByIdsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<FindJourneysByIdsResponse, FindJourneysByIdsError, ThrowOnError>({
...
export const findVehicleCompositionByJourneyId = <ThrowOnError extends boolean = false>(options: Options<FindVehicleCompositionByJourneyIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindVehicleCompositionByJourneyIdResponse, FindVehicleCompositionByJourneyIdError, ThrowOnError>({
...
export const findServerById = <ThrowOnError extends boolean = false>(options: Options<FindServerByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindServerByIdResponse, FindServerByIdError, ThrowOnError>({
...
export const findServerByCode = <ThrowOnError extends boolean = false>(options: Options<FindServerByCodeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindServerByCodeResponse, FindServerByCodeError, ThrowOnError>({
...
export const listServers = <ThrowOnError extends boolean = false>(options?: Options<ListServersData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ListServersResponse, ListServersError, ThrowOnError>({
        url: '/sit-servers/v1/',
        ...options
    });
};
...
export const findRailcarByApiName = <ThrowOnError extends boolean = false>(options: Options<FindRailcarByApiNameData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindRailcarByApiNameResponse, FindRailcarByApiNameError, ThrowOnError>({
...
export const findRailcarById = <ThrowOnError extends boolean = false>(options: Options<FindRailcarByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindRailcarByIdResponse, FindRailcarByIdError, ThrowOnError>({
...
export const findPointByPosition = <ThrowOnError extends boolean = false>(options: Options<FindPointByPositionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindPointByPositionResponse, FindPointByPositionError, ThrowOnError>({
...
export const findPointBySimRailPointId = <ThrowOnError extends boolean = false>(options: Options<FindPointBySimRailPointIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindPointBySimRailPointIdResponse, FindPointBySimRailPointIdError, ThrowOnError>({
...
export const findPointByName = <ThrowOnError extends boolean = false>(options: Options<FindPointByNameData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindPointByNameResponse, FindPointByNameError, ThrowOnError>({
...
export const findPointById = <ThrowOnError extends boolean = false>(options: Options<FindPointByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindPointByIdResponse, FindPointByIdError, ThrowOnError>({
...
export const listPoints = <ThrowOnError extends boolean = false>(options?: Options<ListPointsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ListPointsResponse, ListPointsError, ThrowOnError>({
        url: '/sit-points/v1/',
        ...options
    });
};
...
export const findMapPolylineByJourney = <ThrowOnError extends boolean = false>(options: Options<FindMapPolylineByJourneyData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindMapPolylineByJourneyResponse, FindMapPolylineByJourneyError, ThrowOnError>({
...
export const findJourneysByRailcar = <ThrowOnError extends boolean = false>(options: Options<FindJourneysByRailcarData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindJourneysByRailcarResponse, FindJourneysByRailcarError, ThrowOnError>({
...
export const findJourneysByTail = <ThrowOnError extends boolean = false>(options: Options<FindJourneysByTailData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindJourneysByTailResponse, FindJourneysByTailError, ThrowOnError>({
...
export const findJourneysByPlayableDeparture = <ThrowOnError extends boolean = false>(options: Options<FindJourneysByPlayableDepartureData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindJourneysByPlayableDepartureResponse, FindJourneysByPlayableDepartureError, ThrowOnError>({
...
export const findJourneyById = <ThrowOnError extends boolean = false>(options: Options<FindJourneyByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindJourneyByIdResponse, FindJourneyByIdError, ThrowOnError>({
...
export const findJourneysByEvent = <ThrowOnError extends boolean = false>(options: Options<FindJourneysByEventData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindJourneysByEventResponse, FindJourneysByEventError, ThrowOnError>({
...
export const listActiveJourneys = <ThrowOnError extends boolean = false>(options: Options<ListActiveJourneysData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ListActiveJourneysResponse, ListActiveJourneysError, ThrowOnError>({
...
export const findDispatchPosts = <ThrowOnError extends boolean = false>(options?: Options<FindDispatchPostsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<FindDispatchPostsResponse, FindDispatchPostsError, ThrowOnError>({
...
export const findDispatchPostById = <ThrowOnError extends boolean = false>(options: Options<FindDispatchPostByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindDispatchPostByIdResponse, FindDispatchPostByIdError, ThrowOnError>({
...
export const listBoardDepartures = <ThrowOnError extends boolean = false>(options: Options<ListBoardDeparturesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ListBoardDeparturesResponse, ListBoardDeparturesError, ThrowOnError>({
...
export const listBoardArrivals = <ThrowOnError extends boolean = false>(options: Options<ListBoardArrivalsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ListBoardArrivalsResponse, ListBoardArrivalsError, ThrowOnError>({
