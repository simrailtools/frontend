 ...
 *
 */
export const findUserDetails = <ThrowOnError extends boolean = false>(options: Options<FindUserDetailsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<FindUserDetailsResponses, FindUserDetailsErrors, ThrowOnError, 'data'>({
        responseStyle: 'data',
