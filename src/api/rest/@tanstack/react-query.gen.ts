...
export const findUserDetailsQueryKey = (options: Options<FindUserDetailsData>) => createQueryKey('findUserDetails', options);
 ...
 *
 */
export const findUserDetailsOptions = (options: Options<FindUserDetailsData>) => {
    return queryOptions({
        ...
        queryKey: findUserDetailsQueryKey(options)
    });
};
