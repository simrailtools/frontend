...
export type SimRailUserDto = {
    ...
    avatarUrl: string;
    /**
     * The location of the user (in some form), null if not known
     */
...
export type RailcarDto = {
    ...
    displayName: string;
    /**
     * The baptismal name of the locomotive / wagon, null if none
     */
    name?: string | null;
    /**
...
export type JourneyDto = {
    ...
    serverId: string;
    /**
     * The instant (ISO-8601) when the journey data was last updated
     */
    lastUpdated: string;
    /**
     * The instant (ISO-8601) when the journey was first seen, null if the journey wasn't active yet
     */
    firstSeenTime?: string | null;
    /**
     * The instant (ISO-8601) when the journey was last seen, null if the journey is still or wasn't active
     */
...
export type JourneyEventDto = {
    ...
    /**
     * Scheduled time of the event in local server time (ISO-8601)
     */
    scheduledTime: string;
    /**
     * Best known time of the in local server time (ISO-8601), precision is described by the time type field
     */
    realtimeTime: string;
    /**
...
export type JourneyLiveDataDto = {
    ...
    position: GeoPositionDto;
    /**
     * The current driver of the journey
     */
    driver?: UserDto;
    /**
...
export type JourneySignalDto = {
    ...
    id: string;
    /**
     * The allowed speed of passing the signal, null if no speed reduction
     */
...
export type VehicleSequenceDto = {
    /**
...
export type SimRailServerDto = {
    ...
    code: string;
    /**
     * The offset of the server time from utc in hours
     */
    ...
    tags: Array<string>;
    /**
     * The language spoken on the server, null for all languages
     */
    ...
    lastUpdated: string;
    /**
     * The instant (ISO-8601) when the server was initially registered in the SimRail backend
     */
...
export type JourneyTerminalEventDto = {
    ...
    /**
     * The scheduled time (ISO-8601) in local server time of the event
     */
    scheduledTime: string;
    /**
...
export type JourneyEventDescriptorDto = {
    ...
    stopPlace: JourneyStopPlaceSummaryDto;
    /**
     * The scheduled time in local server time (ISO-8601) of the event
     */
    scheduledTime: string;
    /**
     * Indicates if the event was cancelled
...
export type JourneySummaryWithEventDto = {
    /**
     * The identifier of the journey
     */
    journeyId: string;
    ...
    destinationEvent: JourneyTerminalEventDto;
    /**
     * An event of the journey. The exact nature of this event depends on the context it's returned in
     */
    event: JourneyEventDescriptorDto;
};

export type PaginatedResponseDtoJourneySummaryWithEventDto = {
    /**
     * The items that are one the requested page
     */
    items: Array<JourneySummaryWithEventDto>;
    /**
     * Indicates if more pages are available and can be loaded
     */
    morePages: boolean;
...
export type JourneySummaryWithLiveDataDto = {
    /**
     * The identifier of the journey
     */
    journeyId: string;
    ...
    destinationEvent: JourneyTerminalEventDto;
    /**
     * The live data about the journey
     */
    liveData: JourneyLiveDataDto;
};
...
export type DispatchPostInfoDto = {
    ...
    serverId: string;
    /**
     * The time (ISO-8601 instant) when the dispatch post was last updated
     */
    lastUpdated: string;
    /**
     * The time (ISO-8601 instant) when the dispatch post was registered in the SimRail backend
     */
    registeredSince: string;
    /**
    ...
    difficulty: number;
    /**
     * Realtime information about the dispatch post
     */
    realtimeData: DispatchPostRealtimeDataDto;
    /**
...
export type DispatchPostRealtimeDataDto = {
    /**
     * The user that is currently dispatching the post
     */
    dispatcher?: UserDto;
};
...
export type BoardEntryDto = {
    ...
    additional: boolean;
    /**
     * Scheduled time of the event (ISO-8601) in local server time
     */
    scheduledTime: string;
    /**
     * Best known time of the event (ISO-8601) in local server time, precision is described by the time type field
     */
    realtimeTime: string;
    /**
     * The precision of the realtime time of the event
...
export type FindUserDetailsData = {
    /**
     * An array containing the base information (platform and id) of the users to resolve
     */
    body: Array<UserDto>;
    path?: never;
    query?: never;
...
export type FindUserDetailsErrors = {
    /**
     * The given request body is invalid
     */
    400: ProblemDetail;
    /**
...
export type FindUserDetailsError = FindUserDetailsErrors[keyof FindUserDetailsErrors];

export type FindUserDetailsResponses = {
    /**
...
export type FindUserDetailsResponse = FindUserDetailsResponses[keyof FindUserDetailsResponses];
...
export type FindJourneysByRailcarData = {
    ...
    query: {
        ...
        serverId: string;
        /**
         * The date of an event (ISO-8601), defaults to the current server date if omitted
         */
        date?: string;
        /**
         * The id of the railcars that must be included in the vehicle composition of the journey
         */
        railcars: Array<string>;
        /**
...
export type FindJourneysByPlayableDepartureData = {
    ...
    query: {
        ...
        serverId: string;
        /**
         * The start of the time range (ISO-8601 without offset), defaults to the current server time if omitted
         */
        timeStart?: string;
        /**
         * The end of the time range (ISO-8601 without offset), defaults to start plus 15 minutes if omitted
         */
        timeEnd?: string;
        /**
         * The category of the journey at the first playable event
...
export type FindJourneysByPlayableDepartureResponses = {
     ...
     * The journeys were successfully resolved based on the given filter parameters
     */
    200: PaginatedResponseDtoJourneySummaryWithEventDto;
};
...
export type ListActiveJourneysResponses = {
     ...
     */
    200: Array<JourneySummaryWithLiveDataDto>;
};
